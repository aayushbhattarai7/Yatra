            ...
            {chatLoading ? (
              ...
              messages.map(
                (chat: {
                  ...
                  <div
                    key={chat.id}
                    className={`flex ${chat.senderTravel?.id === selectedTravelId ? "justify-end" : "justify-start"}`}
                  >
                    <div
                      className={`p-3 rounded-lg ${chat.senderTravel?.id === selectedTravelId ? "bg-blue-500 text-white" : "bg-gray-200 text-black"}`}
                    >
