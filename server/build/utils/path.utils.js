...
exports.transferImageFromUploadToTemp =
  exports.getUploadFolderpathForUser =
  exports.getTempFolderPathForUser =
  exports.getTempFolderPathForHotel =
  exports.getUploadFolderpathForHotel =
  exports.getTempFolderPathForTravel =
  exports.getUploadFolderpathForTravel =
  exports.getTempFolderPathForPlace =
  exports.getUploadFolderpathForplace =
  exports.getTempFolderPathForGuide =
  exports.getUploadFolderpathForGuide =
    void 0;
...
const transferImageFromUploadToTemp = (id, name, type) => {
  const UPLOAD_FOLDER_PATH = path_1.default.join(
    (0, exports.getUploadFolderpathForUser)(),
    type.toLowerCase(),
    id.toString(),
  );
  const TEMP_FOLDER_PATH = path_1.default.join(
    (0, exports.getTempFolderPathForUser)(),
    id.toString(),
  );
  ...
  try {
    fs_1.default.renameSync(
      path_1.default.join(UPLOAD_FOLDER_PATH, imageName),
      path_1.default.join(TEMP_FOLDER_PATH, imageName),
    );
  } catch (err) {
