...
class RoomService {
    ...
    travelRepo;
    guideRepo;
    constructor(roomrepo = database_config_1.AppDataSource.getRepository(room_entity_1.Room), userRepo = database_config_1.AppDataSource.getRepository(user_entity_1.User), chatRepo = database_config_1.AppDataSource.getRepository(chat_entity_1.Chat), travelRepo = database_config_1.AppDataSource.getRepository(travel_entity_1.Travel), guideRepo = database_config_1.AppDataSource.getRepository(guide_entity_1.Guide)) {
    ...
    async getConnectedUsers(user_id) {
        try {
            ...
            if (!getConnectUsers)
                throw HttpException_utils_1.default.badRequest("No users are connected");
