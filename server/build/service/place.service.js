...
const PlaceImages_entity_1 = __importDefault(
  require("../entities/place/PlaceImages.entity"),
);
...
class PlaceService {
  ...
  trekkingPlaceRepo;
  constructor(
    placeImageRepo = database_config_1.AppDataSource.getRepository(
      PlaceImages_entity_1.default,
    ),
    ...
    favouritePlaceRepo = database_config_1.AppDataSource.getRepository(
      placefavourite_entity_1.FavouritPlace,
    ),
    trekkingPlaceRepo = database_config_1.AppDataSource.getRepository(
    ...
    try {
      ...
      if (!trekkingPlace) {
        throw HttpException_utils_1.default.notFound(
          "No trekking place found in the message",
        );
      }
