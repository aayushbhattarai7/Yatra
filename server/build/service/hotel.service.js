...
const hotelKyc_entity_1 = __importDefault(
  require("../entities/hotels/hotelKyc.entity"),
);
...
class HotelService {
  ...
  hotelRoomRepo;
  constructor(
    hotelRepo = database_config_1.AppDataSource.getRepository(
      hotel_entity_1.Hotel,
    ),
    locationRepo = database_config_1.AppDataSource.getRepository(
      location_entity_1.Location,
    ),
    hotelDetailsRepo = database_config_1.AppDataSource.getRepository(
    ...
    hotelKycRepo = database_config_1.AppDataSource.getRepository(
      hotelKyc_entity_1.default,
    ),
    hotelRoomRepo = database_config_1.AppDataSource.getRepository(
      hotelRoom_entity_1.HotelRoom,
    ),
  ) {
