...
__decorate(
  [
    ...
    (0, typeorm_1.OneToMany)(
      ...
      (requestTravel) => requestTravel.user,
      {
        onDelete: "CASCADE",
      },
    ),
...
__decorate(
  [
    ...
    (0, typeorm_1.OneToMany)(
      ...
      (requestGuide) => requestGuide.users,
      {
        onDelete: "CASCADE",
      },
    ),
...
__decorate(
  [
    ...
    (0, typeorm_1.OneToMany)(
      ...
      (notification) => notification.senderUser,
      {
        onDelete: "CASCADE",
      },
    ),
...
__decorate(
  [
    ...
    (0, typeorm_1.OneToMany)(
      () => notification_entity_1.Notification,
      (notification) => notification.receiverUser,
      {
        onDelete: "CASCADE",
      },
    ),
...
__decorate(
  [
    (0, type_graphql_1.Field)(() => [userImage_entity_1.default], {
      nullable: true,
    }),
    (0, typeorm_1.OneToMany)(
...
exports.User = User = __decorate(
  [(0, type_graphql_1.ObjectType)(), (0, typeorm_1.Entity)("user")],
  User,
);
