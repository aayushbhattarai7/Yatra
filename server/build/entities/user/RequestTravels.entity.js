...
__decorate([
    ...
    __metadata("design:type", String)
], RequestTravel.prototype, "lastActionBy", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => user_entity_1.User),
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.requestTravel, { cascade: true }),
    (0, typeorm_1.JoinColumn)({ name: "user_id" }),
    __metadata("design:type", user_entity_1.User)
], RequestTravel.prototype, "user", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => travel_entity_1.Travel),
    (0, typeorm_1.ManyToOne)(() => travel_entity_1.Travel, (travel) => travel.requestedTravel, {
        cascade: true,
    }),
    (0, typeorm_1.JoinColumn)({ name: "travel_id" }),
    __metadata("design:type", travel_entity_1.Travel)
], RequestTravel.prototype, "travel", void 0);
exports.RequestTravel = RequestTravel = __decorate([
    (0, type_graphql_1.ObjectType)(),
    (0, typeorm_1.Entity)("request_travel")
], RequestTravel);
