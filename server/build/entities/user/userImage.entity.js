...
let UserImage = class UserImage extends base_entity_1.default {
  ...
  transferImageToUpload(id, type) {
    const TEMP_PATH = path_1.default.join(
      (0, path_utils_1.getTempFolderPathForUser)(),
      this.name,
    );
    const UPLOAD_PATH = path_1.default.join(
      (0, path_utils_1.getUploadFolderpathForUser)(),
      type.toLowerCase(),
      this.id.toString(),
    );
...
UserImage = __decorate(
  [(0, type_graphql_1.ObjectType)(), (0, typeorm_1.Entity)("user_image")],
  UserImage,
);
