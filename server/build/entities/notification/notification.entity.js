...
], Notification.prototype, "senderUser", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => user_entity_1.User),
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (users) => users.notifications, {
        cascade: true,
        nullable: true,
    }),
    (0, typeorm_1.JoinColumn)({ name: "receiver_user_id" }),
    __metadata("design:type", user_entity_1.User)
], Notification.prototype, "receiverUser", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => guide_entity_1.Guide),
    (0, typeorm_1.ManyToOne)(() => guide_entity_1.Guide, (guide) => guide.notification, {
        cascade: true,
        nullable: true,
    }),
    (0, typeorm_1.JoinColumn)({ name: "sender_guide_id" }),
    __metadata("design:type", guide_entity_1.Guide)
], Notification.prototype, "senderGuide", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => guide_entity_1.Guide),
    (0, typeorm_1.ManyToOne)(() => guide_entity_1.Guide, (guide) => guide.notifications, { cascade: true }),
    (0, typeorm_1.JoinColumn)({ name: "receiver_guide_id" }),
    __metadata("design:type", guide_entity_1.Guide)
], Notification.prototype, "receiverGuide", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => travel_entity_1.Travel),
    (0, typeorm_1.ManyToOne)(() => travel_entity_1.Travel, (travel) => travel.notifications, { cascade: true }),
    (0, typeorm_1.JoinColumn)({ name: "receiver_travel_id" }),
    __metadata("design:type", travel_entity_1.Travel)
], Notification.prototype, "receiverTravel", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => travel_entity_1.Travel),
    (0, typeorm_1.ManyToOne)(() => travel_entity_1.Travel, (travel) => travel.notification, { cascade: true }),
    (0, typeorm_1.JoinColumn)({ name: "sender_travel_id" }),
    __metadata("design:type", travel_entity_1.Travel)
], Notification.prototype, "senderTravel", void 0);
