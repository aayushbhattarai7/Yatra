...
let PlaceImage = class PlaceImage extends base_entity_1.default {
    ...
    transferImageToUpload(id, type) {
        const TEMP_PATH = path_1.default.join((0, path_utils_1.getTempFolderPathForPlace)(), this.name);
        const UPLOAD_PATH = path_1.default.join((0, path_utils_1.getUploadFolderpathForplace)(), type.toLowerCase(), this.id.toString());
...
], PlaceImage.prototype, "name", void 0);
__decorate([
    (0, type_graphql_1.Field)({ nullable: true }),
    (0, typeorm_1.Column)({ name: "mimetype", nullable: true }),
    __metadata("design:type", String)
], PlaceImage.prototype, "mimetype", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => enum_1.MediaType),
    (0, typeorm_1.Column)({ enum: enum_1.MediaType, type: "enum" }),
    __metadata("design:type", String)
], PlaceImage.prototype, "type", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => trekkingplace_entity_1.TrekkingPlace, (TrekkingPlace) => TrekkingPlace.images, {
        onDelete: "CASCADE",
    }),
    (0, typeorm_1.JoinColumn)({ name: "TrekkingPlace_id" }),
    __metadata("design:type", trekkingplace_entity_1.TrekkingPlace)
], PlaceImage.prototype, "TrekkingPlace", void 0);
__decorate([
    (0, type_graphql_1.Field)(),
    __metadata("design:type", String)
], PlaceImage.prototype, "path", void 0);
__decorate([
    (0, typeorm_1.AfterLoad)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PlaceImage.prototype, "loadImagePath", null);
PlaceImage = __decorate([
    (0, type_graphql_1.ObjectType)(),
    (0, typeorm_1.Entity)("placesImages")
], PlaceImage);
