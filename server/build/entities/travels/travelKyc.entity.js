...
let TravelKyc = class TravelKyc extends base_entity_1.default {
    name;
    mimetype;
    type;
    fileType;
    travels;
    path;
    transferTravelKycToUpload(id, type) {
        const TEMP_PATH = path_1.default.join((0, path_utils_1.getTempFolderPathForTravel)(), this.name);
        const UPLOAD_PATH = path_1.default.join((0, path_utils_1.getUploadFolderpathForTravel)(), type.toLowerCase(), this.id.toString());
...
], TravelKyc.prototype, "name", void 0);
__decorate([
    (0, type_graphql_1.Field)({ nullable: true }),
    (0, typeorm_1.Column)({
        name: "mimetype",
    ...
    __metadata("design:type", String)
], TravelKyc.prototype, "mimetype", void 0);
__decorate([
    (0, type_graphql_1.Field)(),
    (0, typeorm_1.Column)({ enum: enum_1.MediaType, type: "enum" }),
    __metadata("design:type", String)
], TravelKyc.prototype, "type", void 0);
__decorate([
    (0, type_graphql_1.Field)(),
    (0, typeorm_1.Column)({ enum: enum_1.FileType, type: "enum" }),
    __metadata("design:type", String)
], TravelKyc.prototype, "fileType", void 0);
__decorate([
    (0, type_graphql_1.Field)(() => travel_entity_1.Travel),
    (0, typeorm_1.ManyToOne)(() => travel_entity_1.Travel, (travels) => travels.kyc, {
        onDelete: "CASCADE",
    }),
    (0, typeorm_1.JoinColumn)({ name: "travel_id" }),
    __metadata("design:type", travel_entity_1.Travel)
], TravelKyc.prototype, "travels", void 0);
__decorate([
    (0, type_graphql_1.Field)(),
    __metadata("design:type", String)
], TravelKyc.prototype, "path", void 0);
__decorate([
    (0, typeorm_1.AfterLoad)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TravelKyc.prototype, "loadImagePath", null);
TravelKyc = __decorate([
    (0, type_graphql_1.ObjectType)(),
    (0, typeorm_1.Entity)("travelkyc")
], TravelKyc);
exports.default = TravelKyc;
