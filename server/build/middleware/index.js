...
const middleware = async (app) => {
  ...
  const schema = await (0, type_graphql_1.buildSchema)({
    resolvers: [
      userReslover_1.UserResolver,
      adminResolver_1.AdminResolver,
      GuideReslover_1.GuideResolver,
      travelResolver_1.TravelResolver,
    ],
  });
  ...
  console.log(
    env_config_1.DotenvConfig.DATABASE_USERNAME,
    env_config_1.DotenvConfig.DATABASE_PASSWORD,
    env_config_1.DotenvConfig.DATABASE_NAME,
    env_config_1.DotenvConfig.DATABASE_PASSWORD,
    env_config_1.DotenvConfig.DATABASE_USERNAME,
  );
  app.use(
