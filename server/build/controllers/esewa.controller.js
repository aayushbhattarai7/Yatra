...
class EsewaController {
    async initializePayment(req, res) {
        try {
            ...
            console.log("🚀 ~ EsewaController ~ initializePayment ~ productId:", env_config_1.DotenvConfig.ESEWA_PRODUCT_CODE, env_config_1.DotenvConfig.ESEWA_SECRET_KEY);
            console.log("🚀 ~ EsewaController ~ initializePayment ~ amount:", amount);
            const paymentDetails = await esewa_service_1.default.initializePayment(amount, productId);
