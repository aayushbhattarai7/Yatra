...
class UserController {
    ...
    async updateprofile(req, res) {
        ...
        try {
            ...
            const data = await user_service_1.default.updateProfile(id, req.body, image);
            res.status(StatusCodes_1.StatusCodes.SUCCESS).json({ data });
        }
        catch (error) {
            if (error instanceof Error)
    ...
    async paymentForTravelWithEsewa(req, res) {
        try {
            ...
            const data = await user_service_1.default.advancePaymentForTravelWithEsewa(userId, requestId, token);
    ...
    async paymentForGuideWithEsewa(req, res) {
        try {
            ...
            const data = await user_service_1.default.advancePaymentForGuideWithEsewa(userId, requestId, token);
            res.status(StatusCodes_1.StatusCodes.CREATED).json({ data });
        }
        catch (error) {
            if (error instanceof Error) {
    ...
    async paymentForTravelWithKhalti(req, res) {
        try {
            ...
            const data = await user_service_1.default.advancePaymentForTravelWithKhalti(userId, requestId, pidx);
            res.status(StatusCodes_1.StatusCodes.CREATED).json({ data });
        }
        catch (error) {
            if (error instanceof Error) {
