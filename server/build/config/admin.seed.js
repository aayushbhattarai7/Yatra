...
class SeedAdmin {
  adminRepsository;
  constructor(
    adminRepsository = database_config_1.AppDataSource.getTreeRepository(
  ...
  async createAdmin() {
    try {
      ...
      const hashedPassword = await bcrypt_service_1.default.hash(
        env_config_1.DotenvConfig.ADMIN_PASSWORD,
      );
